...
export type { UseDownloadReturn } from './hooks/useDownload'
...
export { default as SlideShow } from './components/marketing/SlideShow'
export type { SlideShowProps, Slide } from './components/marketing/SlideShow'
export { default as Video } from './components/marketing/Video'
export type { VideoProps } from './components/marketing/Video'
export { default as Parallax } from './components/marketing/Parallax'
export type { ParallaxProps } from './components/marketing/Parallax'
export { default as Blog } from './components/marketing/Blog'
export type { BlogProps, BlogPost } from './components/marketing/Blog'
export { default as Socials } from './components/marketing/Socials'
export type { SocialsProps, SocialLink, SocialPlatform } from './components/marketing/Socials'
export { default as CookieConsent } from './components/marketing/CookieConsent'
export type { CookieConsentProps, ConsentChoice } from './components/marketing/CookieConsent'
export { default as LeadCapture } from './components/marketing/LeadCapture'
export type { LeadCaptureProps } from './components/marketing/LeadCapture'
