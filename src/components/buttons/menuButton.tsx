	...
	return (
		<div className="oxyui__menubutton__wrapper">
			<div className={`oxyui__menubutton`}>
				<button
					onClick={() => oxyOnClick(true)}
					className={`oxyui__menubutton__main oxyui__menubutton__${theme}__${mainButtonType}`}
				>
			...
			{itemsVisible ? (
				<ScalarOpacityTransition delay={0} counter={0}>
					<div
						ref={itemsRef}
						className="oxyui__menubutton__items__wrapper"
					>
						{menuItems.map((item, i) => {
							return item.divider ? (
								...
								<div
									...
									className={`oxyui__menubutton__item oxyui__menubutton__item__${
										i === 0
											? 'first'
